...
import com.cgd.R;
import com.cgd.adapter.PinnedHeaderExpandableAdapter;
import com.cgd.widget.PinnedHeaderExpandableListView;


public class PinnedHeaderExpandableActivity extends Activity{
    private PinnedHeaderExpandableListView explistview;
    private String[][] childrenData = new String[20][20];
    private String[] groupData = new String[20];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pinned_header_expandable);
        initView();
        initData();
    }
