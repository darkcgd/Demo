...
public class ScreenRotateUtil {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 888) {
                ...
                if (orientation > 45 && orientation < 135) {
                    ...
                    if(!isLandscape){
                        Log.i("============","orientation > 45 && orientation < 135");
                    }
                    ...
                    if(isLandscape){
                        Log.i("============","orientation > 135 && orientation < 225");
                    }
                    isLandscape = false;
                } else if (orientation > 225 && orientation < 315) {
                    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
                    if(!isLandscape){
                        Log.i("============","orientation > 225 && orientation < 315");
                    }
                    isLandscape = true;
                } else if ((orientation > 315 && orientation < 360) || (orientation > 0 && orientation < 45)) {
                    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
                    if(isLandscape){
                        Log.i("============","orientation > 315 && orientation < 360");
                    }
                    isLandscape = false;
                }
            }
    ...
    public void toggleRotate() {
        ...
        if (isChangeOrientation) {
            ...
            changeOrientation(isLandscape, isChangeOrientation);
        }
    }
